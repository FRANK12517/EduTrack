...
assert.match(html, /government:'GH₵2 per active student \/ term', private:'GH₵5 per active student \/ term'/);
...
assert.equal(policy.planForSchoolType('PUBLIC').pricePerStudentGhs, 2);
assert.equal(policy.planForSchoolType('PRIVATE').pricePerStudentGhs, 5);
