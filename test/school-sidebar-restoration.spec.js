...
assert.match(sidebar, /function ensureRoot\(\)/, 'School sidebar must recover when the legacy container is absent');
assert.match(sidebar, /function refresh\(\)/, 'School authentication must be able to refresh navigation after session initialization');
